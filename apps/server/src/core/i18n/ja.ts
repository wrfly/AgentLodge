...
export const ja: Record<string, string> = {
  ...
  'No upstream that answers a model list': 'モデル一覧を返せるアップストリームがありません',
  ...
  'The first account cannot be disabled or demoted': '最初のアカウントを無効化または降格することはできません',
  'Unknown role': '不明なロールです',
  'Unknown status': '不明なステータスです',
  'Give an amount above zero': '金額は 0 より大きい値を指定してください',
  ...
  'No model is configured; this service does not use the host CLI login. Add an upstream and pull its models.': 'モデルが未設定です。このサービスはホストの CLI ログインを使いません。先にアップストリームを追加してモデルを取得してください。',
