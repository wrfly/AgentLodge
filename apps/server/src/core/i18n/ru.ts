...
export const ru: Record<string, string> = {
  ...
  'No upstream that answers a model list': 'Нет апстрима, который отвечает списком моделей',
  ...
  'The first account cannot be disabled or demoted': 'Первую учётную запись нельзя отключить или понизить',
  'Unknown role': 'Неизвестная роль',
  'Unknown status': 'Неизвестный статус',
  'Give an amount above zero': 'Укажите сумму больше нуля',
  ...
  'No model is configured; this service does not use the host CLI login. Add an upstream and pull its models.': 'Модели не настроены; этот сервис не использует логин CLI на этой машине. Добавьте апстрим и загрузите модели.',
