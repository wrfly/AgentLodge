...
export const zh: Record<string, string> = {
  ...
  'No upstream that answers a model list': '没有能回答模型清单的上游',
  'No such provider': '不存在',
  'Sending failed': '发送失败',
  'No such user': '用户不存在',
  'The last administrator cannot be disabled or demoted': '不能停用或降级最后一个管理员',
  'The first account cannot be disabled or demoted': '不能停用或降级第一个账号',
  'Unknown role': '未知的角色',
  'Unknown status': '未知的状态',
  'Give an amount above zero': '金额要大于零',
  ...
  'No model is configured; this service does not use the host CLI login. Add an upstream and pull its models.': '没有配置任何模型，本服务不会使用宿主机上的 CLI 登录。请先添加上游并拉取模型。',
